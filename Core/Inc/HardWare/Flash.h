...
extern const uint32_t start_address_sector1; //sector1 start address
extern const uint32_t end_address_sector1;
extern const uint32_t start_address_sector6; //sector6 start address
extern const uint32_t end_address_sector6;
extern const uint32_t start_address_sector7; //sector7 start address
extern const uint32_t end_address_sector7;
extern const uint32_t start_address_sector8; //sector8 start address
extern const uint32_t end_address_sector8;
extern const uint32_t start_address_sector9; //sector9 start address
extern const uint32_t end_address_sector9;
extern const uint32_t start_address_sector10; //sector10 start address
extern const uint32_t end_address_sector10;
extern const uint32_t start_address_sector11; //sector11 start address
extern const uint32_t end_address_sector11;
...
#define BACKUP_FLASH_SECTOR_NUM_6         FLASH_SECTOR_6
#define BACKUP_FLASH_SECTOR_NUM_7         FLASH_SECTOR_7
#define BACKUP_FLASH_SECTOR_NUM_8         FLASH_SECTOR_8
#define BACKUP_FLASH_SECTOR_NUM_9         FLASH_SECTOR_9
#define BACKUP_FLASH_SECTOR_NUM_10         FLASH_SECTOR_10

#define BACKUP_FLASH_SECTOR_NUM_11        FLASH_SECTOR_11

// #define BACKUP_FLASH_SECTOR_SIZE_1           1024*6//6kbyte
// #define BACKUP_FLASH_SECTOR_SIZE_6           1024*6//6kbyte
// #define BACKUP_FLASH_SECTOR_SIZE_11           1024*1 // 全128kbyte
...
// extern char _backup_flash_start_;
// extern char _backup_flash_start_run_log;
